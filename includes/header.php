...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script></script><!----biblioteca java script bootstrap (responsavel pela modal e outros efeitos)-->
...
<nav class="navbar navbar-expand-lg navbar-light bg-light"> <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <ul class="navbar-nav"> 
          <li class="nav-item acolhimento-action"> <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#acolhimentoBioUBS">
               <i class="bi bi-plus-circle-fill"></i> Novo Acolhimento
             </a>
          </li>
      </ul>
    </div> </div> </nav>
