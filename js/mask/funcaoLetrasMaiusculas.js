	...
	// Função para aplicar Title Case no nome do paciente
	function alteraNomePaciente(){
		var input = document.getElementById("nome");
		if(!input) return;
	...
	// Função para aplicar Title Case no nome da mãe do paciente
	function alteraNomeMae(){
		var input = document.querySelector('input[name="nome_mae"]');
		if(!input) return;
